...
export default function NuevoEcommerceProductoPage() {
  ...
  useEffect(() => {
    // Generate or retrieve draftId from sessionStorage for ecommerce
    let id = sessionStorage.getItem('new_ecommerce_product_draft_id')
    if (!id) {
      id = crypto.randomUUID()
      sessionStorage.setItem('new_ecommerce_product_draft_id', id)
    }
    setDraftKey(`product_ecommerce_draft__${id}`)
